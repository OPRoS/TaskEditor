...
/**
 * WorkerElement 모델에 대한 Figure 클래스이다.
 * @author sfline
 */
public class TaskElementFigure extends RectangleFigure implements ICollapsableFigure {
	...
	/** TaskElement 모델의 EditPart */
	private final EditPart editPart;
	/** TaskElement 모델의 icon */
	private ImageFigure iconFigure;	// KJH 20110810
	/** TaskElement 모델의 이름을 표시할 Label */
	private Label nameLabel;
	/** TaskElement 의 child 모델의 Figure 가 표시될 Figure */
...
//		scrollpane.setBorder(new SchemeBorder(SchemeBorder.SCHEMES.ETCHED));
	...
	/**
	 * TaskElement 의 모델 상태를 설정한다.
	 * TaskElement 가 include 되었다면 이름, 펼치기/닫기 등 일부는 수정 될 수 없다.
	 * @param state 모델의 상태
	 */
	...
	/**
	 * TaskElement 모델의 자식 모델들의 Figure 를 표시할 Figure 를 반환한다.
...
//	private static Logger logger = Logger.getLogger(TaskElementFigure.class);
//	/** WorkerElement 모델의 이름을 표시할 Label */
//	private Label nameLabel;
//	
//	/**
//	 * WorkerElement 모델에 대한 Figure 를 생성한다.
//	 */
