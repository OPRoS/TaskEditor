 ...
 */
public class TNavObjectEditPart extends AbstractTreeEditPart implements Adapter {
	 ...
	 */
	public TNavObjectEditPart(Object model) {
		super(model);
	}
...
//			}
	...
	protected Image createImageForModel(Object shape) {
		Image image = null;
		image = TaskModelPlugin.getImageDescriptor("icons/club/B.png").createImage();
		return image;
	}
