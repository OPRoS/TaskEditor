...
/**
 * TreeEditPart used for TaskElement instances (more specific for EllipticalShape and
 ...
 */
public class BNavTaskElementEditPart extends BNavItemElementEditPart {
	
	/**
	 * Create a new instance of this edit part using the given model element.
	 * @param model a non-null Shapes instance
	 */
	public BNavTaskElementEditPart(BehaviorElement model) {
		super(model);
	}
	...
	protected List getModelChildren() {
		BehaviorElement task;
		task = getCastedModel();
		EList<Parameter> list = task.getParams();
		return list;
	}
	...
	protected Image createImageForModel(ItemElement shape) {
		...
		if(baseImage == null) {
			baseImage = TaskModelPlugin.getImageDescriptor("icons/club/task_for_TaskView02.png").createImage();
