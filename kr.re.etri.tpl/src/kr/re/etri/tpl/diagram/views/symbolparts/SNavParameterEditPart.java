 ...
 */
public class SNavParameterEditPart extends SNavItemElementEditPart {
	
	/**
	 * Create a new instance of this edit part using the given model element.
	 * @param model a non-null Shapes instance
	 */
	public SNavParameterEditPart(Parameter model) {
		super(model);
	}
	...
	@Override
	public Parameter getCastedModel() {
	...
	protected Image createImageForModel(ItemElement shape) {
		...
		if(baseImage == null) {
			baseImage = TaskModelPlugin.getImageDescriptor("icons/club/parameter.png").createImage();
