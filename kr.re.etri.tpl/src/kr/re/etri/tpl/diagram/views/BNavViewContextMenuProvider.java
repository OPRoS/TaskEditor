 ...
 */
public class BNavViewContextMenuProvider extends ContextMenuProvider {

/** The editor's action registry. */
private ActionRegistry actionRegistry;

public static final String MENU_ID = "kr.re.etri.tpl.views.TNavViewContextMenu";
 ...
 */
public BNavViewContextMenuProvider(EditPartViewer viewer, ActionRegistry registry) {
	super(viewer);
	if (registry == null) {
