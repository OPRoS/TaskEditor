...
public class BConnectorElementXYLayoutEditPolicy extends XYLayoutEditPolicy {
	private static Logger logger = Logger.getLogger(BConnectorElementXYLayoutEditPolicy.class);
	/** TaskElement 의 EditPart */
	
	/**
	 * ConnectorElement 에 대한 EditPolicy 를 생성한다.
	 * @param editPart
	 */
	public BConnectorElementXYLayoutEditPolicy() {
		
	}
	
//	public BConnectorElementXYLayoutEditPolicy(BLinkedElementEditPart editPart) {
...
//	}
	...
	protected Command getCreateCommand(CreateRequest request) {
		...
		if (!(editPart instanceof BConnectorElementEditPart)) {
			return null;
		}
