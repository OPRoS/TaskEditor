 ...
 *
 */
public class LinkedElementPropertySource extends ShapeElementPropertySource {

	/**
	 * 주어진 model에 대한 PropertySoruce 를 생성한다.
	 * @param model 모델
	 */
	public LinkedElementPropertySource(LinkedElement model) {
		super(model);
	}
	 ...
	 * @Override
	 */
	private LinkedElement getShape() {
