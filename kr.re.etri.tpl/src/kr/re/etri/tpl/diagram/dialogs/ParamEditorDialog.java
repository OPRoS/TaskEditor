...
public class ParamEditorDialog extends TitleAreaDialog{
	...
	public ParamEditorDialog(Shell shell, String title, String message, String contents){
		super(shell);
	...
	public Control createDialogArea(Composite parent) {
		...
		tableParam = new Table(composite, SWT.MULTI | SWT.V_SCROLL | SWT.BORDER);
