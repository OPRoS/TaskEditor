...
public class TaskControllerDialog extends org.eclipse.swt.widgets.Dialog{
	
	public static final String VIEW_ID = "kr.re.etri.tpl.diagram.dialogs.TaskControllerDialog";
...
//	private boolean editable;
	...
	public String home = "./";
	public String path = "./";
//	public TaskControllerDialog(Shell shell, String title, String message, String contents){
//		super(shell);
...
//		dialogShell.layout();
//		dialogShell.pack();			
		dialogShell.setSize(547, 734);
		dialogShell.setText("Task Controller");
		{
			bExit = new Button(dialogShell, SWT.PUSH | SWT.CENTER);
		...
		{
			bConnect = new Button(dialogShell, SWT.PUSH | SWT.CENTER);
			FormData bConnectLData = new FormData();
			bConnectLData.left =  new FormAttachment(0, 1000, 204);
			bConnectLData.top =  new FormAttachment(0, 1000, 666);
...
//					char buffer[] = new char[100];
		...
		{
			sample8 = new Text(dialogShell, SWT.MULTI | SWT.WRAP| SWT.BORDER);
			FormData sample8LData = new FormData();
			sample8LData.left =  new FormAttachment(0, 1000, 106);
			sample8LData.top =  new FormAttachment(0, 1000, 669);
		...
		{
			sample7 = new Text(dialogShell, SWT.MULTI | SWT.WRAP| SWT.BORDER);
			FormData sample7LData = new FormData();
			sample7LData.left =  new FormAttachment(0, 1000, 12);
			sample7LData.top =  new FormAttachment(0, 1000, 669);
		...
		{
			sample6 = new Text(dialogShell, SWT.MULTI |SWT.WRAP| SWT.BORDER | SWT.H_SCROLL | SWT.V_SCROLL);
			FormData sample6LData = new FormData();
			sample6LData.left =  new FormAttachment(0, 1000, 12);
			sample6LData.top =  new FormAttachment(0, 1000, 503);
		...
		}
		{
			...
			label8LData.top =  new FormAttachment(0, 1000, 487);
			...
			}
			{
				...
				bSendRequest.addSelectionListener(new SelectionListener() {
					...
					{						
						...
						sample6.setText(sample6.getText()+str+"\r\n");
						send(str+"\r\n");
						if(receive())
							sample6.setText(sample6.getText()+console);
					}
		...
		}
		{
			...
			}
			{
				...
				bRemove.addSelectionListener(new SelectionListener() {
					...
					public void widgetSelected(SelectionEvent e)
					{
						sample6.setText(sample6.getText()+"remove\r\n");
				...
				bUpload.addSelectionListener(new SelectionListener() {
					...
					public void widgetSelected(SelectionEvent e)
					{
						if(socket == null || socket.isClosed())
							return;
						sample6.setText(sample6.getText()+"upload\r\n");
						ISelection iSelection = tableUpload.getSelection();
						if(((StructuredSelection)iSelection).getFirstElement() == null){
							System.out.println("Warning! dont Selected Table");
							return;
...
//						sample6.setText(sample6.getText()+"select\r\n");
						System.out.println("Mapping Button Push");
						FileDialog fsd = new FileDialog(getParent(),SWT.SAVE);
...
//						System.out.println();
	...
	public void reqnres() {
        try {
        	if(socket !=null && !socket.isClosed()){
        		disconnect();
        		sample6.setText(sample6.getText()+"Disconnect\r\n");
        	}
        	else{
	            connect("127.0.0.1", 6011);
	            sample6.setText(sample6.getText()+"Connect\r\n");
    ...
    public boolean receive(){
    	...
    	while(str.lastIndexOf("00000007TPL-R> ")==-1){
			if(str!=null && !str.trim().equals("")){
				...
				else if(str.startsWith("00000011")){
					mm =  str.substring(8, str.length());
					sample1.setText(mm);
					path = mm;
				}
				...
				sample6.setText(sample6.getText()+mm+"\r\n");
...
//		composite.getShell().setText("Task Controller");
//		setShellStyle(SWT.MODELESS);
//		composite.setLayout(new GridLayout(1, false));
//		GridLayout layout = (GridLayout)composite.getLayout();
////		layout.horizontalSpacing = 32;
////		layout.verticalSpacing = 62;
//		layout.numColumns = 8;
//		GridData data1 = new GridData(GridData.FILL_BOTH);
//		data1.heightHint = 300;
//		data1.widthHint = 600;
//		Group FileUpload = new Group(composite, SWT.SHADOW_ETCHED_IN);
//		FileUpload.setLayout(layout);
//		FileUpload.setText("Task File Upload");
//		FileUpload.setLayoutData(data1);
//		
//		GridData data2 = new GridData();
//		data2.horizontalSpan = 3;
//		data2.widthHint = 210;
//		Label label = new Label(FileUpload, SWT.None);
//		label.setText("Robot's Current(Upload Target) Dir : ");
//		label.setLayoutData(data2);
//		
//		data2 = new GridData();
//		data2.horizontalSpan = 1;
//		data2.widthHint = 60;
//		Button pwd = new Button(FileUpload, SWT.PUSH);
//		pwd.setText("pwd");
//		pwd.setLayoutData(data2);
//		
//		Button dir = new Button(FileUpload, SWT.PUSH);
//		dir.setText("dir");
//		dir.setLayoutData(data2);
//		
//		data2 = new GridData();
//		data2.horizontalSpan = 2;
//		data2.widthHint = 120;
//		Label space = new Label(FileUpload, SWT.None);
//		space.setLayoutData(data2);
//		
//		data2 = new GridData();
//		data2.horizontalSpan = 1;
//		data2.widthHint = 60;
//		Button home = new Button(FileUpload, SWT.PUSH);
//		home.setText("home");
//		home.setLayoutData(data2);
//		
//		data2 = new GridData();
//		data2.horizontalSpan = 5;
//		data2.widthHint = 300;
//		
//		Text textDir = new Text(composite,SWT.NONE);
//		textDir.setText(fullPath);
//		textDir.setLayoutData(data2);
//		
