...
/**
 * This is the item provider adapter for a {@link kr.re.etri.tpl.taskmodel.ActionElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ActionElementItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ActionElement_params_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ActionElement_params_feature", "_UI_ActionElement_type"),
				 TaskModelPackage.Literals.ACTION_ELEMENT__PARAMS,
				 true,
				 false,
				 false,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TaskModelPackage.Literals.ACTION_ELEMENT__PARAMS);
		}
