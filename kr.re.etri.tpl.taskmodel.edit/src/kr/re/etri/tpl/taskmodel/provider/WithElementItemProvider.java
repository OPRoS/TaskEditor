...
/**
 * This is the item provider adapter for a {@link kr.re.etri.tpl.taskmodel.WithElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class WithElementItemProvider
	 ...
	 * @generated
	 */
	public WithElementItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addCyclePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_WithElement_cycle_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_WithElement_cycle_feature", "_UI_WithElement_type"),
				 TaskModelPackage.Literals.WITH_ELEMENT__CYCLE,
				 true,
				 false,
				 false,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/WithElement"));
	}
	...
	public String getText(Object object) {
		String label = ((WithElement)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_WithElement_type") :
			getString("_UI_WithElement_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(WithElement.class)) {
