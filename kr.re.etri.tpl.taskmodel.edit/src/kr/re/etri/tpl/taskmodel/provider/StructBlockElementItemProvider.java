...
/**
 * This is the item provider adapter for a {@link kr.re.etri.tpl.taskmodel.StructBlockElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StructBlockElementItemProvider
	 ...
	 * @generated
	 */
	public StructBlockElementItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addStructTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_StructBlockElement_structType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_StructBlockElement_structType_feature", "_UI_StructBlockElement_type"),
				 TaskModelPackage.Literals.STRUCT_BLOCK_ELEMENT__STRUCT_TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This returns StructBlockElement.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/StructBlockElement"));
	}
	...
	public String getText(Object object) {
		String label = ((StructBlockElement)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_StructBlockElement_type") :
			getString("_UI_StructBlockElement_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(StructBlockElement.class)) {
