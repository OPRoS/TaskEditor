...
/**
 * This is the item provider adapter for a {@link kr.re.etri.tpl.taskmodel.Constant} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TaskModelPackage.Literals.CONSTANT__TYPE,
				 true,
				 false,
				 false,
	...
	protected void addInitValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Constant_initValue_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Constant_initValue_feature", "_UI_Constant_type"),
				 TaskModelPackage.Literals.CONSTANT__INIT_VALUE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
