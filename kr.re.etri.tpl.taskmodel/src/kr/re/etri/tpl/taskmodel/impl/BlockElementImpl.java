 ...
 * <ul>
 *   <li>{@link kr.re.etri.tpl.taskmodel.impl.BlockElementImpl#getStatements <em>Statements</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class BlockElementImpl extends EObjectImpl implements BlockElement {
	/**
	...
	protected EClass eStaticClass() {
		return TaskModelPackage.Literals.BLOCK_ELEMENT;
	}
	...
	public EList<String> getStatements() {
		if (statements == null) {
			statements = new EDataTypeUniqueEList<String>(String.class, this, TaskModelPackage.BLOCK_ELEMENT__STATEMENTS);
		}
		return statements;
	}
